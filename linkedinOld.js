...
const BaseURL = "https://www.linkedin.com/login";
const email = process.env.LINKEDIN_EMAIL;
const password = process.env.LINKEDIN_PASSWORD;
const keyword = "Software Engineer";
const location = "India";
var avgOfExp = 3;
const periodOfTime = "Past Week"; // you can choose : Last 24 hours or Last week
const browserPath = "C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe";
// const resolution = "--window-size=1300,700"; // you can choose : --start-maximized or --window-size=1400,720
const numberOfPagination = 14; // numberOfPagination it means number of execution
const nbrOfOffersPerPage = 25; // don't touch it leave it like this !!
let page = "";
let browser = "";
        ...
        if (state == false) {
          ...
          do {
            ...
            if (
              ...
              if(await page.$(
                'div[class*="artdeco-inline-feedback__message"]'
              )){
                break;
              }
